...
function  create() {
    ...
    var root = 'https://www.zoulang.net/other/ph/?id='
      kd.href = root+myid.value+'&url='+url.value;
      kd.style = '';
      kd.innerText = root+myid.value+'&url='+url.value;
  }
   </script>
   ...
   <p>拍摄后跳转到：<input type= "text" id="url" value= 'https://www.zoulang.net'/></p>
